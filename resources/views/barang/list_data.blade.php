        ...
        @if (count($data) > 0)
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="{{ url('/barang/edit').'/'.$row->id_barang }}" data-id="<?=$row->id_barang?>" data-name="<?=$row->nama?>" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit Barang"><i style="color:#fff;" class="fa fa-edit"></i></a>
