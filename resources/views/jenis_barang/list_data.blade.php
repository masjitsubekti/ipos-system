<div class="table-responsive">
  <table class="table table-bordered">
    <thead class="tr-head">
      <tr>
        <th width="5%" class="text-center sortable" id="column_created" data-sort="" onclick="sort_table('#column_created','created_at')">No </th>
        <th width="70%" class="sortable" id="column_nama" data-sort="asc" onclick="sort_table('#column_nama','nama')">Nama </th>
